...
class PSet3():
    ...
    def iterative_repair(self, n, test=False):
        ...
        def create_locations():  # sets up the locations using a greedy algorithm
            ...
            for col in range(0, dim):       
                ...
                if conflicts == 0: # if no conflicts, place a queen
                    ...
                    change_conf(col, locations[col], 1)
            ...
            for col in col_open:       
                ...
                change_conf(col, locations[col], 1) # update the conflict lists
        ...
        def solve():
            ...
            while (i < max_i):       
                col, num_confs = max_conf() # Calculate the maximum conflicting column and the number of conflicts it contains
                ...
                if (num_confs > 3):  # if the number of conflicts is greater than 3 there are conflicts       
                    ...
                    if (new_location != locations[col]):  # if the better location is found switch location
                        change_conf(col, locations[col], -1) # Remove the conflict moving away
                        locations[col] = new_location  # add a conflict if queen is moving in        
                        change_conf(col, new_location, 1)
...
print(PSet3.standard(1,5,test=True))
#print(PSet3.standard(1,5,test=False))
print(PSet3.standard_return(1))

print(PSet3.BT(1,5,test=True))
#print(PSet3.BT(1,5,test=False))
print(PSet3.BT_return(1))

print(PSet3.BT_w_FC(1,5,test=True))
#print(PSet3.BT_w_FC(1,5,test=False))
print(PSet3.BT_w_FC_return(1))

print(PSet3.iterative_repair(1,50,test=True))
#print(PSet3.iterative_repair(1,6,test=False))
print(PSet3.iterative_repair_return(1))
